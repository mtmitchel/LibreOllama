      ...
      updateElement: (id, updates, options = {}) => {
        ...
        set(state => {
          ...
          if (element) {
            ...
            // Update the Map to trigger re-renders (clone to ensure reference change)
            const newElements = new Map(state.elements);
            newElements.set(id as string, updatedElement);
            state.elements = newElements;
            ...
            if (updatedElement.type === 'section') {
              ...
              if (hasPositionChanged) {
                ...
                newElements2.set(id as string, updatedElement);
                state.elements = newElements2;
              }
            }
