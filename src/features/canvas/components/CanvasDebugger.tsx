 ...
 * 
 * @pure - Production tree-shaking marker
 * This component should be excluded from production builds
 */
/*#__PURE__*/
...
/*#__PURE__*/
export default process.env.NODE_ENV !== 'production' ? CanvasDebugger : (() => null) as React.FC;
