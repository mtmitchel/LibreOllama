...
import { richTextManager } from '../components/rich-text-system/UnifiedRichTextManager';
        ...
        >
          ...
          {shouldShowMainText && hasRichTextSegments && (() => {
            ...
            if (textRef.current) {
              ...
              if (stage) {
                triggerLayerRedraw({ current: stage }, { immediate: true, debug: false });
              }
            }
            return null;
          })()}
