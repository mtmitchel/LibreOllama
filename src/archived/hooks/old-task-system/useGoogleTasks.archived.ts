...
export function useTaskLists() {
  const setTaskLists = useGoogleTasksStore(state => state.setTaskLists);
...
export function useTasks(tasklistId: string) {
  const setTasks = useGoogleTasksStore(state => state.setTasks);
...
export function useCreateTask() {
  ...
  const addTask = useGoogleTasksStore(state => state.addTask);
...
export function useDeleteTask() {
  const queryClient = useQueryClient();
  const removeTask = useGoogleTasksStore(state => state.removeTask);
...
export function useTaskWithMetadata(tasklistId: string, taskId: string) {
  ...
  const task = useGoogleTasksStore(state => 
