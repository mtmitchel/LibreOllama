    ...
    variants: {
      variant: {
        ...
        primary: designSystemFlags.useV2Components
          ? "bg-blue-600 text-white shadow-sm hover:bg-blue-700 active:bg-blue-800 focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-900"
          : "bg-primary text-primary-foreground shadow hover:bg-primary/90 focus-visible:ring-primary",
        
        // V2 Secondary - Target design slate with better contrast
        secondary: designSystemFlags.useV2Components
          ? "bg-slate-700 text-slate-200 border border-slate-600 shadow-sm hover:bg-slate-600 active:bg-slate-500 focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-900"
        ...
        // V2 Ghost - Minimal style with better contrast and hover states
        ghost: designSystemFlags.useV2Components
          ? "text-slate-300 hover:text-white hover:bg-slate-700/60 active:bg-slate-600/80 focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-900 transition-all duration-200 ease-in-out"
