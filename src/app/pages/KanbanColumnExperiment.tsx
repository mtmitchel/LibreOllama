...
import { UnifiedTaskCardExperiment } from './UnifiedTaskCardExperiment';
...
interface KanbanColumnExperimentProps {
...
export const KanbanColumnExperiment: React.FC<KanbanColumnExperimentProps> = ({ 
  column, 
  className = '',
  searchQuery = '',
  onDelete,
