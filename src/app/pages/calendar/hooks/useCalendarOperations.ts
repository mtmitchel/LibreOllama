  ...
  const calendarEventsWithTasks = useMemo(() => {
    ...
    calendarEvents.forEach(event => {
      ...
      const processedEvent: CalendarEvent = {
        ...
        allDay: isAllDay,
        backgroundColor: isTrueMultiDay ? '#d8d0ff' : 'var(--accent-primary)',
        borderColor: isTrueMultiDay ? '#c7bbff' : 'var(--accent-primary)',
      ...
      if (task.due) {
        ...
        if (task.timeBlock) {
          ...
          events.push({
            ...
            allDay: false,
            backgroundColor: isCompleted ? 'var(--bg-tertiary)' : '#E3F2FD',
            borderColor: isCompleted ? 'var(--border-secondary)' : '#2196F3',
            textColor: isCompleted ? 'var(--text-tertiary)' : '#1565C0',
            type: 'task',
            source: 'google',
            extendedProps: {
              type: 'task' as const,
          ...
          events.push({
            ...
            allDay: true,
            backgroundColor: isCompleted ? 'var(--bg-tertiary)' : '#FFF3E0',
            borderColor: isCompleted ? 'var(--border-secondary)' : '#FFB74D',
            textColor: isCompleted ? 'var(--text-tertiary)' : '#E65100',
            type: 'task',
            source: 'google',
            extendedProps: {
              type: 'task' as const,
