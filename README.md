...
| **🎨 Canvas** | A professional-grade, infinite whiteboard powered by **Konva.js**. Perfect for brainstorming, user flows, mind-mapping, and visual thinking. Features include sticky notes, shapes, rich text editing with real-time formatting (bold, italic, underline), freehand drawing, and transform controls. |
