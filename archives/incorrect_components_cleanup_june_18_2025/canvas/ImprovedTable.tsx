...
import { useCanvasElements } from '../../features/canvas/stores/canvasStore';
import { designSystem } from '../../styles/designSystem';
import { throttleRAF } from '../../features/canvas/utils/events';
...
const ImprovedTable: React.FC<ImprovedTableProps> = ({
  ...
  const headerTimeoutRef = useRef<NodeJS.Timeout | null>(null);  const editorRef = useRef<HTMLTextAreaElement | null>(null);
