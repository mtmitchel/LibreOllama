...
import { useCanvasElements, useCanvasUI, useCanvasHistory, useSelection, useTextEditing, useSections } from '../../features/canvas/stores/canvasStore';
...
import { 
  ...
  Trash2,
            ...
            selectElement(tableElement.id);w,
  Download,
  Upload,
  Save,
  FolderOpen,
            ...
            if (file) {
              ...
              reader.onload = (event) => {
                ...
                img.onload = () => {
                  ...
                  const targetSection = CoordinateService.findSectionAtPoint(
                    { x: imageElement.x, y: imageElement.y },
                    sections
                  );
