...
> = (set, get) => ({
  ...
  setSelectedTool: (tool: string) => {
    ...
    try {
      ...
      recordMetric('toolSwitch', 1, 'interaction', { 
  ...
  toggleLeftSidebar: () => {
    ...
    recordMetric('panelToggle', 1, 'interaction', { panel: 'leftSidebar' });
  ...
  toggleRightSidebar: () => {
    ...
    recordMetric('panelToggle', 1, 'interaction', { panel: 'rightSidebar' });
  ...
  toggleBottomPanel: () => {
    ...
    recordMetric('panelToggle', 1, 'interaction', { panel: 'bottomPanel' });
  ...
  togglePropertiesPanel: () => {
    ...
    recordMetric('panelToggle', 1, 'interaction', { panel: 'propertiesPanel' });
  ...
  toggleLayersPanel: () => {
    ...
    recordMetric('panelToggle', 1, 'interaction', { panel: 'layersPanel' });
  ...
  showModal: (modal: Omit<ModalState, 'id' | 'isVisible'>): string => {
    ...
    recordMetric('modalShow', 1, 'interaction', { type: modal.type });
  ...
  hideModal: (modalId?: string) => {
    ...
    recordMetric('modalHide', 1, 'interaction');
  ...
  showContextMenu: (position: { x: number; y: number }, items: Array<{
    ...
    recordMetric('contextMenuShow', 1, 'interaction');
  ...
  showNotification: (notification: Omit<CanvasUIState['notifications'][0], 'id' | 'timestamp' | 'isVisible'>): string => {
    ...
    recordMetric('notificationShow', 1, 'interaction', { type: notification.type });
