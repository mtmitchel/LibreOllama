...
> = (set, get) => ({
  ...
  addHistoryEntry: (action: string, patches: Patch[], inversePatches: Patch[], metadata?: HistoryEntry['metadata']) => {
    ...
    try {
      ...
      recordMetric('historyEntryAdded', patches.length, 'canvas', { 
        action,
  ...
  undo: () => {
    ...
    try {
      ...
      recordMetric('undoOperation', 1, 'canvas', { 
        action: entry.action,
  ...
  redo: () => {
    ...
    try {
      ...
      recordMetric('redoOperation', 1, 'canvas', { 
        action: entry.action,
  ...
  clearHistory: () => {
    ...
    try {
      ...
      recordMetric('historyClear', historyLength, 'canvas');
  ...
  compactHistory: () => {
    ...
    try {
      ...
      recordMetric('historyCompact', 1, 'canvas');
    } finally {
      endTiming();
    }
  },
  ...
  jumpToHistoryIndex: (index: number): Patch[] | null => {
    ...
    recordMetric('historyJump', Math.abs(index - currentIndex), 'canvas');
  ...
  optimizeHistoryMemory: () => {
    ...
    try {
      ...
      recordMetric('historyMemoryOptimize', 1, 'canvas');
    } finally {
      endTiming();
    }
  }
